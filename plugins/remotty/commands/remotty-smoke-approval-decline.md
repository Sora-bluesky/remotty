...
7. Run `remotty telegram smoke approval decline --config $configPath`.
8. Follow the local terminal guidance and use Telegram to press `Deny` when the pending request appears.
9. Confirm that the smoke finished with a success message and no target file was created.
