...
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle '## 5. Start Codex CLI'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'You will use these PowerShell windows:'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'Setup PowerShell'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'Bridge PowerShell'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle '"$env:APPDATA\remotty\bridge.toml"'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'Keep Bridge PowerShell open while you use Telegram.'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'Run this in Setup PowerShell:'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'Open Codex PowerShell'
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'Open Bridge PowerShell'
...
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '## 5. `Codex CLI` を起動する'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle 'この手順では、次の PowerShell 画面を使い分けます。'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '設定用 PowerShell'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle 'ブリッジ用 PowerShell'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '"$env:APPDATA\remotty\bridge.toml"'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle 'Telegram から使う間は、ブリッジ用 PowerShell を開いたままにします。'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '設定用 PowerShell で実行します。'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle 'Codex 用 PowerShell を開き'
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle 'ブリッジ用 PowerShell を開き'
...
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '`remotty` が起動中のブリッジ用 PowerShell には入力しません'
