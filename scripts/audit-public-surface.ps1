...
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'Start Codex CLI from that project'
...
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '手元の画面でセッションを確認したい場合'
